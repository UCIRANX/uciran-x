...
```
ربات نسبت تصویر (۱۰۲۴ به ۷۲۰) را حفظ می‌کند اما برای صرفه‌جویی در مصرف Neuron روی پلن رایگان، بزرگ‌ترین ضلع را حداکثر 800 پیکسل می‌سازد. در `/edit` هم این نسبت به‌طور خودکار از روی عکس اصلی گرفته می‌شود و نیازی به وارد کردن سایز نیست.
